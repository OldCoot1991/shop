...
export default function ApiProductDetail({ product }: ApiProductDetailProps) {
  ...
  const categoryNamesMap: Record<string, number> = {
    ...
    "аудио колонки": 2,
    "батарейки и аккумуляторы": 3,
    "держатели и подставки для телефона": 4,
    "зарядные устройства": 5,
    "кабели для телефона": 6,
    "компьютерные комплектующие": 7,
    "наушники": 8,
    "стекла защитные для телефонов": 9,
    "телефоны": 10,
    "флешки и карты памяти оптом": 12,
    "электроника, гаджеты, аксессуары": 13,
  };
